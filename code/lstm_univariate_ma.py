...
history = model.fit(train_X, train_y, epochs=200, batch_size=50,
                    validation_data=(test_X, test_y), verbose=2, shuffle=False)
print(history.history)

plt.plot(history.history['loss'])
plt.plot(history.history['val_loss'])
plt.title('LSTM Base Model with MA loss')
plt.ylabel('loss')
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper right')
plt.savefig('/home/sklakshminarayanan/stock_data/model/lstm_uv_ma_loss.png')
plt.show()


yhat = model.predict(test_X)
test_X = test_X.reshape((test_X.shape[0], 25))
temp = test_X[:, -25:]
...
inv_y = np.concatenate((test_y, test_X[:, -25:]), axis=1)
...
loss.to_csv('/home/sklakshminarayanan/stock_data/data/lstm_uv_ma_loss.csv',
            index=None)
...
lstm_mv.to_csv('/home/sklakshminarayanan/stock_data/data/lstm_uv_ma_pred.csv',
               index=None)

plt.plot(inv_y)
plt.plot(inv_yhat)
plt.title('LSTM Base Model with MA Test vs Prediction')
plt.ylabel('close')
plt.xlabel('date')
plt.legend(['test', 'predicted'], loc='lower left')
plt.savefig(
    '/home/sklakshminarayanan/stock_data/model/lstm_uv_ma_testvspred.png')
plt.show()
...
plt.plot(a['test'])
plt.title('LSTM Base Model with MA Prediction')
plt.ylabel('stock price')
plt.xlabel('date')
plt.legend(['train', 'test', 'predicted'], loc='upper left')
plt.savefig('/home/sklakshminarayanan/stock_data/model/lstm_uv_ma_predfull.png')
plt.show()
