...
loss.to_csv('/home/sklakshminarayanan/stock_data/data/svr_uv_loss.csv',index=None)

svr1 = {}
svr1['pred'] = yhat
svr1['test'] = y_test
svr_uv = pd.DataFrame(svr1)
svr_uv.to_csv('/home/sklakshminarayanan/stock_data/data/svr_uv_pred.csv',index=None)

plt.plot(y_test)
plt.plot(yhat)
plt.title('SVR Base Model Test vs Prediction')
plt.ylabel('close')
plt.xlabel('date')
plt.legend(['test', 'predicted'], loc='lower left')
plt.savefig('/home/sklakshminarayanan/stock_data/model/svr_uv_testvspred.png')
plt.show()
...
plt.savefig('/home/sklakshminarayanan/stock_data/model/svr_uv_predfull.png')
plt.show()
